...
public class JDCParser/*@bgen(jjtree)*/implements JDCParserTreeConstants, JDCParserConstants {/*@bgen(jjtree)*/
  protected static JJTJDCParserState jjtree = new JJTJDCParserState();private static List<Throwable> errorList = new ArrayList<Throwable>(); //list of errors
    static boolean inLoopCondition; //indicates whether or not the current expansion is within an if loop condition e.g. if (...)
...
*/
 ...
 Token t;
  ...
  static void error_skipto(int kind, ParseException ex) throws ParseException {
errorList.add(ex);
Token t;
do {
t = getNextToken();
